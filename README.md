...
If you want to deploy a demo environment, please [download and modify the file Deployment-DemoEnvironment.ps1](https://github.com/KnudsenMorten/ClientInspectorV2-DeploymentKit/raw/main/Deployment-DemoEnvironment.ps1) (right-click and choose 'save link as'). Just fill out **Azure SubscriptionId** and **Azure TenantId** - and you will get a complete environment with this configuration. 
